                    ...
                    <div class="box box-primary">
						...
						echo $edit_data['dob'] = date('d-m-Y', strtotime($edit_data['dob']));
                                             ...
                                             <div class="form-group">
                                                ...
                                                ?>               
                                                 	<input type="radio" name="gender" <?php echo $male; ?> value="male" checked> Male<br>
                                                    <input type="radio" name="gender" <?php echo $female; ?> value="female"> Female<br>
  							                        <input type="radio" name="gender" <?php echo $other; ?> value="other"> Other 
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                             <label> Area</label>
                                             <input id="searchTextField" value="<?php
                                                if (set_value('area'))
                                                    echo set_value('area');
                                                else if (isset($edit_data['area']))
                                                    echo $edit_data['area'];
                                                ?>" class="form-control required"   name="area" type="text" size="50">
                                             </div>
                                            ...
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Are you interested to donate blood?<br/> </label><br/>
                                                 ...
                                                 if (isset($edit_data['interested']))
                                                    {
                                                        //var_dump($edit_data['interested']);
                                                    $value=$edit_data['interested'];
                                                ...
                                                ?>                                      
                                                 	<input type="radio" name="interested" value="yes" <?php echo $yes; ?> />&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;
  													<input type="radio" name="interested" value="no" <?php echo $no; ?> />&nbsp; No<br>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <?php
                                                 ...
                                                 if (isset($edit_data['donate']))
                                                    {
                                                        //var_dump($edit_data['interested']);
                                                    $value=$edit_data['donate'];
                                                    ...
                                                    ?>
                                                 	<input type="radio" name="donate" value="yes" onclick="show()"  <?php echo $yes; ?>>&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;
  													<input type="radio" name="donate" value="no" onclick="hide()"  <?php echo $no; ?> >&nbsp; No<br>
                                            ...
                                            <div  id="predate" class="form-group ">
                                               ...
                                               if (set_value('previous_date'))
                                                    ...
                                                    if($edit_data['previous_date']!='0000-00-00')

						echo $edit_data['previous_date'] = date('d/m/Y', strtotime($edit_data['previous_date']));
                                                    }
                                                    else
                                                    {
                                                        echo $edit_data['previous_date'] = '00-00-0000';
                                                    }
